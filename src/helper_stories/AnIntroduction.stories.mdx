...
6. Since all the components are wrapper components upon Material UI, please visit [material docs](https://material-ui.com/getting-started/installation/) for additional information.
