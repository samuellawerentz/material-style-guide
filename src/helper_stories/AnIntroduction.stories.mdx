...
<Canvas><Story id="icons-basic-usage--different-sizes"/></Canvas>

The icons used are taken from the Google Material Design icon package. We use Material Rounded Icons throughout our App. For icon names, please visit [Google Material Icon Website](https://fonts.google.com/icons)
